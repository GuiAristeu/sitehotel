    ...
    <h1>DÚVIDAS</h1>
        <ul>
            <li class="opcoes" onclick="expandirResposta('resposta1')">Reservas</li>
    ...
    <footer id="rodape">
            <ul class="rodape">
                <li><a target="_blank" href="https://goo.gl/maps/ECkG7ksKJuW6rP7s6">Localização</a></li>
                <li><a target="_blank" href="https://www.whatsapp.com/">(99) 90000-0000</a></li>
                <li><a href="">contato@email.com</a></li>
            </ul>
    </footer>